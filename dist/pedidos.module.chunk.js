...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__model_producto_rangoPrecioProducto_model__ = __webpack_require__("../../../../../src/app/model/producto/rangoPrecioProducto.model.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__model_mensajes_model__ = __webpack_require__("../../../../../src/app/model/mensajes.model.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__model_producto_fichaTecnica_model__ = __webpack_require__("../../../../../src/app/model/producto/fichaTecnica.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__model_producto_detalleTalla_model__ = __webpack_require__("../../../../../src/app/model/producto/detalleTalla.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__model_pedido_detallePedido_model__ = __webpack_require__("../../../../../src/app/model/pedido/detallePedido.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__model_pedido_medioPago_model__ = __webpack_require__("../../../../../src/app/model/pedido/medioPago.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__model_producto_tipoProducto_model__ = __webpack_require__("../../../../../src/app/model/producto/tipoProducto.model.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_clientes_service__ = __webpack_require__("../../../../../src/app/services/clientes.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_pedidos_service__ = __webpack_require__("../../../../../src/app/services/pedidos.service.ts");
...
var FormPedidoComponent = (function () {
    ...
    FormPedidoComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.producto = new __WEBPACK_IMPORTED_MODULE_1__model_producto_producto_model__["a" /* Producto */]();
        this.tipoProducto = new __WEBPACK_IMPORTED_MODULE_9__model_producto_tipoProducto_model__["a" /* TipoProducto */]();
        this.rangoPrecio = new __WEBPACK_IMPORTED_MODULE_0__model_producto_rangoPrecioProducto_model__["a" /* RangoPrecioProducto */]();
        ...
        //lista de pedidos
        this.clientesService.getClientes('buscar', 'Activo', '').subscribe(function (data) {
            console.log('obteniendo lista clientes...');
            console.log(data);
            _this.listaClientes = data;
        });
        this.productosService.getProductos().subscribe(function (data) {
            console.log('this.listaProductos: ', _this.listaProductos);
            _this.listaProductos = data;
        });
        this.detallePedido = new __WEBPACK_IMPORTED_MODULE_7__model_pedido_detallePedido_model__["a" /* DetallePedido */]();
        this.medioPago = new __WEBPACK_IMPORTED_MODULE_8__model_pedido_medioPago_model__["a" /* MedioPago */]();
        this.detallePedido.listaAdicionales = new Array();
        this.detallePedido.listaDetalleTallas = new Array();
        this.rangoPrecioProducto = new __WEBPACK_IMPORTED_MODULE_0__model_producto_rangoPrecioProducto_model__["a" /* RangoPrecioProducto */]();
    };
    ...
    FormPedidoComponent.prototype.onSelectProducto = function () {
    ...
    FormPedidoComponent.prototype.onSelectTipoProducto = function () {
    ...
    FormPedidoComponent.prototype.addTallasProducto = function () {
        ...
        for (var c = 0; c < this.detallePedido.cantidad; c++) {
            this.detalleTallas = new __WEBPACK_IMPORTED_MODULE_6__model_producto_detalleTalla_model__["a" /* DetalleTalla */]();
        ...
        this.detallePedido.fichaTecnica = new __WEBPACK_IMPORTED_MODULE_5__model_producto_fichaTecnica_model__["a" /* FichaTecnica */]();
    };
    ...
    FormPedidoComponent.prototype.guardarPedido = function () {
        ...
        if (this.tipoForm === 'editar') {
            ...
            //Emite mensaje
            var msg = new __WEBPACK_IMPORTED_MODULE_3__model_mensajes_model__["a" /* Mensajes */]();
            msg.fecha = new Date();
            msg.usuarioOrigen = 'usuario origen';
            msg.usuarioDestino = 'usuario destino';
...
FormPedidoComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__services_chat_service__["a" /* ChatService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__services_chat_service__["a" /* ChatService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_13__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_13__angular_router__["a" /* ActivatedRoute */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_13__angular_router__["f" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_13__angular_router__["f" /* Router */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_12__services_pedidos_service__["a" /* PedidosService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_12__services_pedidos_service__["a" /* PedidosService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_2__services_productos_service__["a" /* ProductosService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_productos_service__["a" /* ProductosService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_11__services_clientes_service__["a" /* ClientesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_11__services_clientes_service__["a" /* ClientesService */]) === "function" && _f || Object])
], FormPedidoComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_commons_service__ = __webpack_require__("../../../../../src/app/services/commons.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__commons_subir_archivos_subir_archivos_component__ = __webpack_require__("../../../../../src/app/pages/commons/subir-archivos/subir-archivos.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__form_modulos_form_modulos_component__ = __webpack_require__("../../../../../src/app/pages/pedidos/form-modulos/form-modulos.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pedidos_router__ = __webpack_require__("../../../../../src/app/pages/pedidos/pedidos.router.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pedidos_component__ = __webpack_require__("../../../../../src/app/pages/pedidos/pedidos.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__form_pedido_form_pedido_component__ = __webpack_require__("../../../../../src/app/pages/pedidos/form-pedido/form-pedido.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__file_upload_file_upload_component__ = __webpack_require__("../../../../../src/app/file-upload/file-upload.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__form_pedido_form_pedido_module__ = __webpack_require__("../../../../../src/app/pages/pedidos/form-pedido/form-pedido.module.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__tallas_pedidos_tallas_pedidos_component__ = __webpack_require__("../../../../../src/app/pages/pedidos/tallas-pedidos/tallas-pedidos.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__ft_pedidos_ft_pedidos_component__ = __webpack_require__("../../../../../src/app/pages/pedidos/ft-pedidos/ft-pedidos.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var pedidosRoutes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_13__pedidos_component__["a" /* PedidosComponent */] },
    { path: 'formPedido/:tipoForm', component: __WEBPACK_IMPORTED_MODULE_15__form_pedido_form_pedido_component__["a" /* FormPedidoComponent */] },
    { path: 'formPedido/:tipoForm/:id', component: __WEBPACK_IMPORTED_MODULE_15__form_pedido_form_pedido_component__["a" /* FormPedidoComponent */] },
    { path: 'formTallas/:id', component: __WEBPACK_IMPORTED_MODULE_19__tallas_pedidos_tallas_pedidos_component__["a" /* TallasPedidosComponent */] },
    { path: 'formTallas/:tipoForm/:id', component: __WEBPACK_IMPORTED_MODULE_19__tallas_pedidos_tallas_pedidos_component__["a" /* TallasPedidosComponent */] },
    { path: 'formFichaTecnica/:id', component: __WEBPACK_IMPORTED_MODULE_20__ft_pedidos_ft_pedidos_component__["a" /* FtPedidosComponent */] },
    { path: 'formFichaTecnica/:tipoForm/:id', component: __WEBPACK_IMPORTED_MODULE_20__ft_pedidos_ft_pedidos_component__["a" /* FtPedidosComponent */] },
    { path: 'formModulos/:modulo/:id', component: __WEBPACK_IMPORTED_MODULE_4__form_modulos_form_modulos_component__["a" /* FormModulosComponent */] },
];
...
PedidosModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_11__angular_core__["NgModule"])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_10__pedidos_router__["a" /* pedidosRouter */],
            __WEBPACK_IMPORTED_MODULE_14__angular_router__["g" /* RouterModule */],
            ...
            __WEBPACK_IMPORTED_MODULE_17__form_pedido_form_pedido_module__["a" /* FormPedidoModule */],
            ...
            __WEBPACK_IMPORTED_MODULE_14__angular_router__["g" /* RouterModule */].forChild(pedidosRoutes),
        ],
        providers: [
            __WEBPACK_IMPORTED_MODULE_6__services_pedidos_service__["a" /* PedidosService */],
            __WEBPACK_IMPORTED_MODULE_5__services_clientes_service__["a" /* ClientesService */],
            __WEBPACK_IMPORTED_MODULE_2__services_commons_service__["a" /* CommonsService */],
            __WEBPACK_IMPORTED_MODULE_1__services_productos_service__["a" /* ProductosService */]
        ],
        declarations: [
            __WEBPACK_IMPORTED_MODULE_13__pedidos_component__["a" /* PedidosComponent */],
            __WEBPACK_IMPORTED_MODULE_15__form_pedido_form_pedido_component__["a" /* FormPedidoComponent */],
            __WEBPACK_IMPORTED_MODULE_16__file_upload_file_upload_component__["a" /* FileUploadComponent */],
            __WEBPACK_IMPORTED_MODULE_19__tallas_pedidos_tallas_pedidos_component__["a" /* TallasPedidosComponent */],
            __WEBPACK_IMPORTED_MODULE_20__ft_pedidos_ft_pedidos_component__["a" /* FtPedidosComponent */],
            __WEBPACK_IMPORTED_MODULE_4__form_modulos_form_modulos_component__["a" /* FormModulosComponent */],
            __WEBPACK_IMPORTED_MODULE_3__commons_subir_archivos_subir_archivos_component__["a" /* SubirArchivosComponent */]
        ]
    })
], PedidosModule);
